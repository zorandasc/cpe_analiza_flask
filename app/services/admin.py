...
def get_cpe_inventory_chart_data(city_id=1, cpe_type_id=1, weeks=None):
    params = {}
    ...
    if cpe_type_id:
        where += " AND cpe_type_id= :cpe_type_id"
...
def get_cpe__dismantle_inventory_chart_data(
    city_id=None, cpe_type_id=None, dismantle_type=None, weeks=None
):
    pass
